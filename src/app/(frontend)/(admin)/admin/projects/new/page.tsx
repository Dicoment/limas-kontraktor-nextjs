...
export default async function NewProjectPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <ProjectFormInner categories={categories} teams={teams} />
    </div>
  )
}

function ProjectFormInner({ categories, teams }: { categories: any[]; teams: any[] }) {
  return (
    <div className="bg-white rounded-lg shadow p-6 space-y-6">
      ...
      <form action="/api/projects" method="POST" className="flex gap-3">
