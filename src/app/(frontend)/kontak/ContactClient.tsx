...
export default function ContactClient() {
  ...
  return (
    <main className="min-h-screen bg-white font-sans antialiased overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-white/80 text-base md:text-lg leading-relaxed">
            Jasa kontraktor terpercaya di Bekasi, Jakarta, and Jabodetabek.<br />
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="bg-[#0F2340] rounded-2xl p-10 flex flex-col items-center gap-4 hover:bg-[#1a3560] transition-colors duration-300 shadow-md shadow-slate-900/5 cursor-default"
            >
        ...
        <motion.div 
          ...
          className="rounded-2xl overflow-hidden shadow-lg h-96 w-full border border-slate-100"
        >
          <iframe
