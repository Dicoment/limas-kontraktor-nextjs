  ...
  return (
    <section className="bg-white py-16 md:py-24 overflow-hidden relative border-t border-slate-50">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Heading Tengah — Responsif text size */}
        <div className="text-center mb-12 md:mb-20">
          <div className="inline-flex items-center gap-2 bg-[#0F2340]/5 backdrop-blur-md border border-[#0F2340]/10 px-4 py-1.5 rounded-full w-fit mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-[#E87722] animate-pulse" />
            <p className="text-[#0F2340] text-xs font-semibold tracking-widest uppercase">Mengapa Memilih Kami</p>
          </div>
          
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-[#0F2340] leading-[1.2] md:leading-[1.15] tracking-tight uppercase max-w-4xl mx-auto">
            Komitmen Kontraktor Bangunan <span className="text-[#E87722]">& Renovasi Profesional</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="grid-cols-1 lg:col-span-7 order-2 lg:order-1 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 md:gap-6 bg-slate-50/60 border border-slate-100 p-4 rounded-2xl">
              <Button href="/tentang" variant="secondary" size="md" className="gap-2 shrink-0 w-full sm:w-auto justify-center">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {["SIUJK", "NIB", "OSS"].map((item) => (
                    <span
                      key={item}
                      className="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-slate-200 rounded-md text-[10px] font-bold text-gray-600 shadow-sm"
                    >
                      <MdOutlineVerified size={12} className="text-[#E87722]" />
                      {item}
                    </span>
                  ))}
                </div>
