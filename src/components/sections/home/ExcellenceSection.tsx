      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <motion.div 
            ...
            className="grid-cols-1 lg:col-span-5 order-1 lg:order-2 relative w-full mb-6 lg:mb-0 lg:sticky lg:top-28"
          >
            ...
            <motion.div 
              ...
              whileHover={{ y: -3 }}
              className="absolute -bottom-4 right-4 lg:right-auto lg:-left-4 bg-[#E87722] text-white rounded-xl px-5 py-3.5 md:px-6 md:py-4 shadow-xl shadow-orange-950/20"
            >
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="grid-cols-1 lg:col-span-7 order-2 lg:order-1 space-y-8"
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#0F2340] leading-[1.2] md:leading-[1.15] tracking-tight uppercase max-w-4xl mx-auto">
              Jasa Kontraktor Bangunan <span className="text-[#E87722]"><br />&amp; Renovasi Profesional</span>
            </h2>
            ...
            <motion.div 
              ...
              className="flex flex-col sm:flex-row sm:items-center gap-6 pt-6 border-t border-gray-200/60"
            >
