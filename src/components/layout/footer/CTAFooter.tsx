...
export default function CTAFooter({ waPhone = "6282320721150" }: { waPhone?: string }) {
  ...
  return (
    <section className="bg-white text-slate-900 font-sans border-t border-slate-200/80 py-12 md:py-28 relative">
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <motion.div 
          ...
          className="mb-10 md:mb-16 space-y-3 md:space-y-4 max-w-4xl"
        >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-5 space-y-6 md:space-y-10">
            <p className="text-base md:text-sm lg:text-base text-slate-500 leading-relaxed font-normal max-w-md">
            ...
            <div className="space-y-6 md:space-y-10 pt-2 md:pt-4">
              {[
                ...
                <div key={n} className="group flex items-start gap-4 sm:gap-6">
                  <span className="text-xl sm:text-2xl font-mono font-light text-slate-300 group-hover:text-slate-900 transition-colors duration-300 pt-0.5">
                    {n}
                  </span>
