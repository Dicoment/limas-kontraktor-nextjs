...
import { FaRegTrashCan, FaStar, FaYoutube, FaLink } from "react-icons/fa6"
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 space-y-5">
          ...
          <div className="flex gap-3 border-t border-slate-100 pt-5">
            ...
            <a
              ...
              className="px-4 py-2 text-sm border border-slate-200 rounded-md hover:bg-slate-50 text-slate-600"
            >
              Batal
            </a>
          </div>
